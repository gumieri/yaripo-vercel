      ...
      <div className="w-full max-w-sm">
        ...
        <div className="border-border/50 rounded-xl border bg-card p-6 shadow-lg shadow-black/20">
          ...
          >
            <button
              type="submit"
              className="border-border hover:bg-secondary text-foreground flex w-full items-center justify-center gap-3 rounded-lg border px-4 py-3 text-sm font-medium transition-colors"
            >
          ...
          >
            <button
              type="submit"
              className="bg-foreground hover:bg-foreground/80 text-background flex w-full items-center justify-center gap-3 rounded-lg px-4 py-3 text-sm font-medium transition-colors"
            >
