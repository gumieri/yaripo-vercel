  ...
  await db.insert(schema.attempts).values([
    {
      ...
      isTop: true,
      attemptCount: 1,
      resultData: { top: true, zone: true, attempts: 1, attempts_to_top: 1 },
      idempotencyKey: crypto.randomUUID(),
    },
    {
      sectorId: s5,
      ...
      isTop: true,
      attemptCount: 2,
      resultData: { top: true, zone: true, attempts: 2, attempts_to_top: 2 },
      idempotencyKey: crypto.randomUUID(),
    },
    {
      sectorId: s4,
      athleteId: F.athletes[4].id,
      judgeId,
      isTop: true,
      attemptCount: 3,
      resultData: { top: true, zone: true, attempts: 3, attempts_to_top: 3 },
      idempotencyKey: crypto.randomUUID(),
    },
    {
      sectorId: s5,
      ...
      isTop: false,
      attemptCount: 5,
      resultData: { top: false, zone: true, attempts: 5, attempts_to_top: null },
      idempotencyKey: crypto.randomUUID(),
    },
  ])
}
