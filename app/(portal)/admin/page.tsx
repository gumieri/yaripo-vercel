    ...
    <div className="flex flex-1 flex-col px-4 py-12">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-3">
        <div className="border-border/50 rounded-xl border bg-card p-6">
          ...
          <p className="text-muted-foreground mt-1 text-sm">Eventos ativos</p>
        </div>
        <div className="border-border/50 rounded-xl border bg-card p-6">
          ...
          <p className="text-foreground text-2xl font-bold">0</p>
          <p className="text-muted-foreground mt-1 text-sm">Setores configurados</p>
        </div>
        <div className="border-border/50 rounded-xl border bg-card p-6">
          ...
          <p className="text-foreground text-2xl font-bold">0</p>
          <p className="text-muted-foreground mt-1 text-sm">Atletas registrados</p>
        </div>
      </div>
    </div>
  )
